                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ url('signup') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input id="age" name="age" type="number" class="form-control form-control-user py-2" placeholder="Edad">
                                        @error('age')
                                        <span class="invalid-feedback d-block">
                                            {{ $message }}
                                        </span>
                                    ...
                                    <div class="col-sm-6">
                                        <select id="genre" name="genre" class="form-select form-control-user py-2" aria-label="Género">
